...
public class EjemploLinkedList {
    public static void main(String[] args) {
        ...
        /*Crea una lista vacia para almacenar objetos del tipo Alumno
        instancia <del tipo> nombre = new claseLinkedList ---------*/
        ...
        //Para agregar al principio y agregar al final
